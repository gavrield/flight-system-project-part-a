...
public class ConstantsAndQueries {
    ...
    public static String SQL_GET_FLIGHTS = "SELECT * FROM get_flights();";
    public static String SQL_GET_USERS = "SELECT * FROM get_users();";
    public static String SQL_GET_USER_ROLES = "SELECT * FROM \"User_Roles\";";
    public static String SQL_GET_AIRLINE_COMPANIES = "SELECT * FROM get_airline_companies();";
    public static String SQL_GET_ADMINISTRATORS = "SELECT * FROM get_administrators();";
    public static String SQL_GET_CUSTOMERS = "SELECT * FROM get_customers();";
    public static String SQL_GET_COUNTRIES = "SELECT * FROM \"Countries\";";
    public static String SQL_GET_TICKETS = "SELECT * FROM get_tickets();";
    ...
    public static String sqlGetCustomerById(int id) {
        return "SELECT * FROM get_customers() AS \"customers\" WHERE \"customers\".\"customer_id \" = "
                + id + ";";
    }
    ...
    public static String sqlDeleteCustomer(Customer customer) {
        return "DELETE FROM \"Customers\" WHERE \"Customers\".\"Id\" = " + customer.id + ";";
    }
    ...
    public static String sqlInsertTicket(Ticket ticket) {
        return String.format("INSERT INTO \"Tickets\" (\"Flight_Id\", \"Customer_Id\")" +
                "VALUES(%d,%d);", ticket.flight.id, ticket.customer.id);
    }

    public static String sqlDeleteTicket(Ticket ticket) {
        return "DELETE FROM \"Tickets\" WHERE \"Tickets\".\"Id\" = " + ticket.id + ";";
    }
